...
/*   Updated: 2025/08/21 21:17:40 by antonsplavn      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(const AForm& form) const{
	...
	try{
		form.execute(*this);
		std::cout << getName() << " executed successfully " << form.getName() << std::endl;
	}
	catch(const std::exception& e){
		std::cout << getName() << " execution failed " << form.getName() << " -- "<< e.what() << std::endl;
	}
}
